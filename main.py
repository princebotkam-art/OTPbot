...
# Bot configuration
BOT_TOKEN = os.getenv('8073903913:AAHEZZDpvk4WiFjrig2h9LhAcB5Sy-JobUM')
GROUP_ID = os.getenv('-1003868394296')
IVASMS_EMAIL = os.getenv('ryder261649@maillii.website')
IVASMS_PASSWORD = os.getenv('OMU BABY890')
